...
class Deck:
    ...
    def reshuffle(self):
        ...
        #requests.get("https://deckofcardsapi.com/api/deck/2p31ozwsltaj/shuffle/")
    ...
    def draw_card(self):
        ...
        #requests.get("https://deckofcardsapi.com/api/deck/2p31ozwsltaj/draw/?count=2")
        #pass
